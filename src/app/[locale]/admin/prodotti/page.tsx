...
export default async function AdminProdottiPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (p: any) => <RowActions id={p.id} editHref={`/admin/prodotti/${p.id}`} label="il prodotto" deleteEntity="product" />
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="admin-page-heading">
        ...
        <Link href="/admin/prodotti/nuovo" className="admin-primary-action">
          <Plus className="size-4" /> Nuovo prodotto
        </Link>
      </div>
